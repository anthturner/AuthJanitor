...
{
    public class ConnectionStringConsumingWebAppApplication : ConsumingWebAppApplication<ConnectionStringConfiguration>
    {
        public ConnectionStringConsumingWebAppApplication(ILogger logger,
